...
import (
  ...
  "fmt"
	...
	"github.com/hanapedia/microservice-topologies/tracing-example-app/fanout-2/connections/mongo"
	pb "github.com/hanapedia/microservice-topologies/tracing-example-app/fanout-2/pb-fanout-2"
)
...
func (s fanout_2Server) Check(ctx context.Context, req *healthpb.HealthCheckRequest) (*healthpb.HealthCheckResponse, error) {
	return &healthpb.HealthCheckResponse{Status: healthpb.HealthCheckResponse_SERVING}, nil
}

func (s fanout_2Server) Watch(req *healthpb.HealthCheckRequest, ws healthpb.Health_WatchServer) error {
