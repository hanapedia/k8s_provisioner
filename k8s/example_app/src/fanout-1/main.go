...
import (
  ...
  "fmt"
	...
	"github.com/hanapedia/microservice-topologies/tracing-example-app/fanout-1/connections/mongo"
	pb "github.com/hanapedia/microservice-topologies/tracing-example-app/fanout-1/pb-fanout-1"
)
...
func (s fanout_1Server) Check(ctx context.Context, req *healthpb.HealthCheckRequest) (*healthpb.HealthCheckResponse, error) {
	return &healthpb.HealthCheckResponse{Status: healthpb.HealthCheckResponse_SERVING}, nil
}

func (s fanout_1Server) Watch(req *healthpb.HealthCheckRequest, ws healthpb.Health_WatchServer) error {
