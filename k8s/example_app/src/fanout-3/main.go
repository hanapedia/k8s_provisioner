...
import (
  ...
  "fmt"
	...
	"github.com/hanapedia/microservice-topologies/tracing-example-app/fanout-3/connections/mongo"
	pb "github.com/hanapedia/microservice-topologies/tracing-example-app/fanout-3/pb-fanout-3"
)
...
func (s fanout_3Server) Check(ctx context.Context, req *healthpb.HealthCheckRequest) (*healthpb.HealthCheckResponse, error) {
	return &healthpb.HealthCheckResponse{Status: healthpb.HealthCheckResponse_SERVING}, nil
}

func (s fanout_3Server) Watch(req *healthpb.HealthCheckRequest, ws healthpb.Health_WatchServer) error {
